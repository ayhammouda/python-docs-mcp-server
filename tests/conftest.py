...
_STABILITY_SYMBOLS = [
    ("asyncio.TaskGroup", "asyncio", "class", "library/asyncio-task.html#asyncio.TaskGroup", "asyncio.TaskGroup"),
    ("asyncio.run", "asyncio", "function", "library/asyncio-runner.html#asyncio.run", "asyncio.run"),
    ("json.dumps", "json", "function", "library/json.html#json.dumps", "json.dumps"),
    ("json.loads", "json", "function", "library/json.html#json.loads", "json.loads"),
    ("os.path.join", "os.path", "function", "library/os.path.html#os.path.join", "os.path.join"),
    ("pathlib.Path", "pathlib", "class", "library/pathlib.html#pathlib.Path", "pathlib.Path"),
    ("collections.OrderedDict", "collections", "class", "library/collections.html#collections.OrderedDict", "collections.OrderedDict"),
    ("typing.Optional", "typing", "data", "library/typing.html#typing.Optional", "typing.Optional"),
    ("re.compile", "re", "function", "library/re.html#re.compile", "re.compile"),
    ("subprocess.run", "subprocess", "function", "library/subprocess.html#subprocess.run", "subprocess.run"),
    ("logging.getLogger", "logging", "function", "library/logging.html#logging.getLogger", "logging.getLogger"),
    ("sqlite3.connect", "sqlite3", "function", "library/sqlite3.html#sqlite3.connect", "sqlite3.connect"),
    ("http.server.HTTPServer", "http.server", "class", "library/http.server.html#http.server.HTTPServer", "http.server.HTTPServer"),
    ("urllib.parse.urlparse", "urllib.parse", "function", "library/urllib.parse.html#urllib.parse.urlparse", "urllib.parse.urlparse"),
    ("dataclasses.dataclass", "dataclasses", "function", "library/dataclasses.html#dataclasses.dataclass", "dataclasses.dataclass"),
    ("functools.lru_cache", "functools", "function", "library/functools.html#functools.lru_cache", "functools.lru_cache"),
    ("itertools.chain", "itertools", "function", "library/itertools.html#itertools.chain", "itertools.chain"),
    ("contextlib.contextmanager", "contextlib", "function", "library/contextlib.html#contextlib.contextmanager", "contextlib.contextmanager"),
    ("abc.ABC", "abc", "class", "library/abc.html#abc.ABC", "abc.ABC"),
    ("enum.Enum", "enum", "class", "library/enum.html#enum.Enum", "enum.Enum"),
    ("datetime.datetime", "datetime", "class", "library/datetime.html#datetime.datetime", "datetime.datetime"),
    ("hashlib.sha256", "hashlib", "function", "library/hashlib.html#hashlib.sha256", "hashlib.sha256"),
    ("socket.socket", "socket", "class", "library/socket.html#socket.socket", "socket.socket"),
    ("threading.Thread", "threading", "class", "library/threading.html#threading.Thread", "threading.Thread"),
    ("multiprocessing.Process", "multiprocessing", "class", "library/multiprocessing.html#multiprocessing.Process", "multiprocessing.Process"),
    ("sys.argv", "sys", "data", "library/sys.html#sys.argv", "sys.argv"),
    ("os.environ", "os", "data", "library/os.html#os.environ", "os.environ"),
    ("io.StringIO", "io", "class", "library/io.html#io.StringIO", "io.StringIO"),
    ("csv.reader", "csv", "function", "library/csv.html#csv.reader", "csv.reader"),
    ("argparse.ArgumentParser", "argparse", "class", "library/argparse.html#argparse.ArgumentParser", "argparse.ArgumentParser"),
]
